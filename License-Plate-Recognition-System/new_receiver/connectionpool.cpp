...
ConnectionPool::ConnectionPool() {
    ...
    if(!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
        ...
        QString s=bt;
        parser->setMessage(s);
        qDebug()<<"*************set DB from setting.txt**************";
        hostName     = parser->getHostName();
        databaseName = parser->getDataBaseName();
        databaseType = parser->getDataBaseType();
        testOnBorrow = parser->getTestOnBorrow();
        testOnBorrowSql = parser->getTestOnBorrowSql();

        maxWaitTime  = parser->getMaxWaitTime();
        waitInterval = parser->getWaitInterval();
        maxConnectionCount  = parser->getMaxConnectionCount();
    }
