...
#include "./process_h/core_func.h"
#include "./process_h/util.h"

void learn2HasPlate(float bound = 0.7)
{

    const char * filePath = "./data/plate_detect_svm/learn/HasPlate";
    ...
    for (int i = 0; i < boundry; i++)
    {
        ...
        if(1)
        {
            ...
            ss << "./data/plate_detect_svm/train/HasPlate/hasplate_" << i << ".jpg";
            imwrite(ss.str(), img);
        }
    }
    ...
    for (int i = boundry; i < size; i++)
    {
        ...
        {
            stringstream ss(stringstream::in | stringstream::out);
            ss << "./data/plate_detect_svm/test/HasPlate/hasplate_" << i << ".jpg";
            imwrite(ss.str(), img);
        }
    }
}
...
void learn2NoPlate(float bound = 0.7)
{
    ...
    const char * filePath = "./data/plate_detect_svm/learn/NoPlate";
    ...
    for (int i = 0; i < boundry; i++)
    {
        ...
        {
            stringstream ss(stringstream::in | stringstream::out);
            ss << "./data/plate_detect_svm/train/NoPlate/noplate_" << i << ".jpg";
            imwrite(ss.str(), img);
        }
    }
    ...
    for (int i = boundry; i < size; i++)
    {
        ...
        {
            stringstream ss(stringstream::in | stringstream::out);
            ss << "./data/plate_detect_svm/test/NoPlate/noplate_" << i << ".jpg";
            imwrite(ss.str(), img);
        }
    }
}
...
{
    int label = 1;
    const char * filePath = "./data/plate_detect_svm/train/HasPlate";
...
{
    int label = 0;
    const char * filePath = "./data/plate_detect_svm/train/NoPlate";
...
{
    int label = 1;
    const char * filePath = "./data/plate_detect_svm/test/HasPlate";
...
{
    int label = 0;
    const char * filePath = "./data/plate_detect_svm/test/NoPlate";
