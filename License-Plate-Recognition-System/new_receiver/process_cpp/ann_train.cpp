...
int saveTrainData()
{
    ...
    string path = "./data/chars_recognise_ann/chars2";
    ...
    path = "./data/chars_recognise_ann/charsChinese";
...
{
    FileStorage fs;
    //string data_path = "./train/ann_data_"+std::to_string(_predictsize)+"_"+std::to_string(_neurons)+".xml";
