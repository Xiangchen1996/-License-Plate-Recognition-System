#include "./process_h/chars_segment.h"
...
//        imwrite("./image/inputgray2.jpg",input_grey);
...
//        imwrite("./image/inputgray2.jpg",input_grey);
    ...
    if (m_debug)
    {
        ...
        ss << "image/debug_char_threshold" <<iTag<< ".jpg";
//        imwrite(ss.str(), img_threshold);
    ...
    {
        stringstream ss(stringstream::in | stringstream::out);
        ss << "image/debug_char_clearLiuDing" <<iTag<< ".jpg";
//        imwrite(ss.str(), img_threshold);
    }
    iTag++;
